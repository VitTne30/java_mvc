...
public class ForgetService {
    ...
    public ForgetService(ForgetView newForgetView) throws SQLException {
        ...
        Document doc = forgetView.getFindAcc().getDocument();
        doc.addDocumentListener(new DocumentListener() {
            ...
            public void insertUpdate(DocumentEvent e) {
                try {
                    ...
                    Logger.getLogger(ForgetService.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
