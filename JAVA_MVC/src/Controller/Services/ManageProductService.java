...
public final class ManageProductService {
    ...
    public ManageProductService(ProductView one) throws SQLException {
    ...
    public void exportToExcel(JTable t) {
        try {
            ...
            jFileChooser.showSaveDialog(PView);
            ...
            if (saveFile != null) {
                ...
                for(int j = 0; j < t.getRowCount(); j++){
                    ...
                    for(int k = 0; k < t.getColumnCount(); k++){
                        ...
                        if(t.getValueAt(j,k )!= null){
                            cell.setCellValue(t.getValueAt(j, k).toString());
                        }
                    }
                }
                ...
                showMessengerError("Tập tin lỗi!");
            }
